...
var bootstrap = require('common:widget/ui/lib/bootstrap/bootstrap.js');
...
$(function(){
    ...
    // +'        <li><a id="normal-mode" href="#normal-mode">正常模式</a></li>'
    // +'        <li><a id="fixedtop-mode" href="#fixedtop-mode">顶部固定模式</a></li>'
    // +'        <li><a id="fixedside-mode" href="#fixedside-mode">导航固定模式</a></li>'
    // +'        <li><a id="fixedsideonly-mode" href="#fixedsideonly-mode">双边固定模式</a></li>'
    // +'    </ul>'
